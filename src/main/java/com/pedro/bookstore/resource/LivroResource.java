...
public class LivroResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Livro> update(@PathVariable Integer id, @RequestBody Livro livroBody) {
	...
	public ResponseEntity<Livro> updatePatch(@PathVariable Integer id, @RequestBody Livro livroBody) {
		Livro livro = livroService.update(id, livroBody);
	...
	@PostMapping
	public ResponseEntity<Livro> create(@RequestParam(value = "categoria", defaultValue = "0") Integer idCategoria, @RequestBody Livro livroBody) {
